...
<div class="container mt-5">
    <div class="row">
        <div class="col-12">
            <h5 class="mb-4">AI인공지능 정보공유 모임 약관</h5>
                    <h6>제 1조 (정의)</h6>
                    <p>1. "모임장"이라 함은 AI인공지능 정보공유 모임의 모임장을 의미합니다.<br>
                    2. "모임 운영진"이라 함은 AI인공지능 정보공유 모임의 운영진을 의미합니다.<br>
                    3. "정모 주최자"라 함은 AI인공지능 정보공유 모임에서 정모를 주최하는 주최자를 의미하며,<br> 모임원이라면 누구든지 정모 주최가 가능합니다(스터디 포함).</p>
                    <h6>제 2조 (정모 회비 및 참가비)</h6>
                    <p>1. 정모회비의 정의 : 해당금액은 정모 진행에 필요한 금액을 모금한 것입니다.<br> 정모 주최자가 사용내역을 공개하며, 잔여금액이 있을 경우 모든 참여자에게 균등하게 반환됩니다.<br>
                    2. 참가비의 정의 : 해당금액은 정모진행자의 모임진행을 위한 준비 및 운영비(수고비포함)입니다.<br> 사용내역 공지는 진행하지 않으며, 참가비의 10%는 모임전체회비로 이용됩니다.</p>
                    <h6>제 3조 (모임 전체회비)</h6>
    ...
    <div class="row mt-5">
        <div class="col-12">
            <h5 class="mb-4">기타 모임 공지</h5>
                    <h6>[모임 소개]</h6>
                    <p>소모임 오픈톡을 운영 중입니다. AI에 대한 관심사를 나누고 정보를 공유하는 모임입니다. </p>
                    <h6>[참가 방법]</h6>
                    <p>우측 오픈톡입장을 통해 참가하실 수 있습니다. ☞<a href="https://open.kakao.com/o/gEw0Wlnf">오픈톡입장</a></p>
                    <h6>[모임 주제]</h6>
                    <p>매주 다양한 AI 관련 주제로 모임이 진행됩니다.</p>
                    <h6>[주의사항]</h6>
                    <p>모임 참석 시 미리 준비된 자료를 통해 참여해주세요.</p>
        </div>
    </div>
</div>
